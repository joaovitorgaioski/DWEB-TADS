            ...
            <div class="col">
                <table class="table table-hover table-responsive">
                    ...
                    <tr>
                        ...
                        <td><%if(u.getEndereco() == null) { %>
                            <p class="text-muted">Não há endereço cadastrado</p>
                            <a class="btn btn-primary btn-sm" href="endereco.jsp?operation=novo&idUsuario=<%=u.getId()%>">
                                Cadastrar endereço
                            </a>
                        <% } else { %>
                            ...
                            <%=u.getEndereco().getCidade()%>/<%=u.getEndereco().getEstado()%>
                            CEP: <%=u.getEndereco().getCep()%>

                            <a class="btn btn-warning btn-sm" href="endereco.jsp?operation=update&idUsuario=<%=u.getId()%>">
                                Editar
                             </a>
                        <% } %>
                        </td>
                        ...
                        <td class="text-end">
                            <a class="btn btn-success"
                               href="usuario.jsp?operation=update&id=<%=u.getId()%>"
                               role="button">Alterar</a>
                            <a class="btn btn-danger"
                               href="usuario.jsp?operation=delete&id=<%=u.getId()%>"
