...
public class Example3 {
    ...
    /**
     * Sending an email to two recipients with two attachments included in the message body.
     * 
     * @param args 
     */
    public static void main(String[] args) {
        ...
        try {
            ...
            attachments.add(new File("src/main/java/br/edu/ifpr/irati/jmail/demo/anexo1.odt"));
            attachments.add(new File("src/main/java/br/edu/ifpr/irati/jmail/demo/anexo2.pdf"));
