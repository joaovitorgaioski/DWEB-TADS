            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                if (btnCancel) {
                    btnCancel.addEventListener('click', function() {
                        window.location.href = 'usuario/findall';
                    });
                }
            });
        </script>
...
<body>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <a class="btn btn-success"
                               href="usuario/findbyid?id=<%=u.getId()%>"
                               role="button">Alterar</a>
                            <a class="btn btn-danger"
                               href="usuario/delete?id=<%=u.getId()%>"
    ...
    <form action=<%= usuario.getId().equals(0L) ? "usuario/create" : "usuario/update" %> method="post">
